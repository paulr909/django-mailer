...
class UnsubscribeView(DeleteView):
    ...
    def get_success_url(self):
        ...
        return reverse(
            "mailinglist:subscribe", kwargs={"mailinglist_id": mailing_list.id}
        )
...
class CreateMessageView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse(
            "mailinglist:manage_mailinglist", kwargs={"pk": self.object.mailing_list.id}
        )
    ...
    def get_mailing_list(self):
        mailing_list = get_object_or_404(MailingList, id=self.kwargs["mailinglist_id"])
